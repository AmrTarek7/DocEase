  ...
  template: `<div class="col-span-12 lg:col-span-6 xl:col-span-3">
      <div class="card mb-0">
        <div class="flex justify-between mb-4">
          <div>
            <span class="block text-muted-color font-bold  mb-4" dir="rtl"
              >طلبات قيد الانتظار</span
            >
            <div
        ...
        <span class="text-primary font-medium"> جديدة {{ 22 | number }}</span>
        <span class="text-muted-color">طلبات</span>
      </div>
    </div>
